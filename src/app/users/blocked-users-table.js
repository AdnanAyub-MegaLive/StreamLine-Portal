...
export default function BlockedUsersTable({initialUsers,initialDevices}) {
  ...
  const [devices,setDevices]=useState(initialDevices.filter((device)=>device.isDeviceBanned));
