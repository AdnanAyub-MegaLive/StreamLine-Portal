...
export default async function AgenciesPage() {
  ...
  return <main className="min-h-screen bg-[#f4f8f7] text-[#142c2a]">
    ...
    <section className="lg:pl-64">
      ...
      <div className="mx-auto max-w-7xl p-6 md:p-10"><div className="mb-7"><h2 className="text-2xl font-bold">Agency management</h2><p className="mt-1.5 text-sm text-[#71847f]">Monitor agency rankings, host targets, tasks, applications, and salary activity.</p></div><AgencyTabs/></div>
    </section>
  </main>;
}
