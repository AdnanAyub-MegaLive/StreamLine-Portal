...
const features = [
  ...
  ["Host Verification", "Identity and profile verification", "/talents?tab=Verification"],
  ["Gifts Received", "Review gifts received by hosts", "/talents?tab=Gifts%20Received"],
  ["Salary History", "Review host salary payments", "/talents?tab=Salary%20History"],
  ["Host Device Information", "Host login devices and bans", "/talents?tab=Device%20Information"],
  ["Live History", "Review host live sessions", "/talents?tab=Live%20History"],
  ["Host Performance", "Review performance metrics", "/talents?tab=Performance"],
  ["Host Violations", "Review compliance violations", "/talents?tab=Violations"],
  ...
  ["Host Salaries", "Review agency host salary calculations", "/agencies?tab=Host%20Salaries"],
